...
func (a *API) Endpoints() {
	a.Router.Handle("/api/v1/url", save.New(a.log, a.db, a.kf, a.cfg.Address, a.cache)).Methods("POST")
	a.Router.HandleFunc("/api/v1/url/{slug}", redirect.New(a.log, a.db, a.cache)).Methods("GET")
}
